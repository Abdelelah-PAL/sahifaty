            ...
            GestureDetector(
                    ...
                    child: Padding(
                        ...
                        child: Column(children: [
                          ...
                          const CustomAuthTextFieldHeader(  text:'البريد الإلكتروني',),
                          ...
                          const CustomAuthTextFieldHeader(   text: 'كلمة المرور',),
                          CustomAuthenticationTextField(
                          ...
                          CustomAuthBtn(
                            ...
                            onTap: () async {
                              ...
                              if (!_authController.noneIsEmpty) {
                                ...
                                if (user == null) {
                                  setState(() {
                                    _authController.loginErrorText = "خطأ في البريد الالكتروني أو كلمة المرور";
